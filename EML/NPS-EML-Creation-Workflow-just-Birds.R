...
data_files <- c("BirdObservationsThru2022_3.csv",
...
data_names <- c("Bird Observations - Site Conditions Data",
...
data_descriptions <- c("Bird observations taken using variable circular plots using continuous distance",
...
data_taxa_tables <- c("BirdSpeciesNames.csv")
